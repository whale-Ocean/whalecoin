...
class WalletTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 WhaleCoin from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 WhaleCoin with subtract fee from amount
        ...
        # Sendmany 10 WhaleCoin with subtract fee from amount
