...
class AvoidReuseTest(BitcoinTestFramework):
    ...
    def test_fund_send_fund_senddirty(self):
        '''
        Test the same as test_fund_send_fund_send, except send the 10 WhaleCoin with
        the avoid_reuse flag set to false. This means the 10 WhaleCoin send should succeed,
    ...
    def test_fund_send_fund_send(self, second_addr_type):
        ...
        [0] sends 10 WhaleCoin to A.
        [1] spends 5 WhaleCoin from A. (leaving roughly 5 WhaleCoin useable)
        [0] sends 10 WhaleCoin to A again.
        [1] tries to spend 10 WhaleCoin (fails; dirty).
        [1] tries to spend 4 WhaleCoin (succeeds; change address sufficient)
        '''
