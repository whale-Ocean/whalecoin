...
public:
    CMainParams() {
        ...
        const uint256 GENESIS_HASH = uint256S("0000069f1a8fe9e1df80b24b58415c19d96774f8b29186861ac8fc37edeb3316");
        ...
        genesis = CreateGenesisBlock(1702083600, 1400092, 0x1e0fffff, 1, 50 * COIN);
...
public:
    CTestNetParams() {
        ...
        const uint256 GENESIS_HASH = uint256S("3559436b0951c5db3eb52ae4e8d756cc47ae1d85839b0f53a25d9954e13304cf");
        consensus.nSubsidyHalvingInterval = 2102400;
        consensus.BIP16Exception = GENESIS_HASH;
        consensus.BIP34Height = 1;
        consensus.BIP34Hash = GENESIS_HASH;
        ...
        // The half life for the testnet ASERT DAA. For every (nASERTHalfLife) seconds behind schedule the blockchain gets,
        // difficulty is cut in half. Doubled if blocks are ahead of schedule.
        // One hour
        consensus.nASERTHalfLife = 60 * 60;

        // Feb 05, 2022 00:30:15 GMT testnet protocol upgrade
        consensus.asertActivationTime = 1688198901;

        consensus.asertAnchorParams = Consensus::Params::ASERTAnchor{
          28,       // anchor block height
          0x1d003fff,   // anchor block nBits
          1702083700,   // anchor block previous block timestamp
        };
        ...
        genesis = CreateGenesisBlock(1702083700, 0, 0x207fffff, 1, 50 * COIN);
//        MineGenesis(genesis,consensus.powLimit,false);
        consensus.hashGenesisBlock = genesis.GetHash();
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        genesis = CreateGenesisBlock(1702083800, 0, 0x207fffff, 1, 50 * COIN);
//        MineGenesis(genesis,consensus.powLimit,false);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("66113b1f2f595bb0c20fa89bdd9a21dd795550c013c8f4c3589cd05cf9ab4b9f"));
        assert(genesis.hashMerkleRoot == uint256S("c4a47847658174dff39f23e69c2246e7e611752884ceb600694a8619adbbfef5"));
        ...
        checkpointData = {
            {
                {0, uint256S("66113b1f2f595bb0c20fa89bdd9a21dd795550c013c8f4c3589cd05cf9ab4b9f")},
            }
        };
