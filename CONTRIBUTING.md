Contributing to WhaleCoin Core
============================

The WhaleCoin Core is based on the Bitcoin Core. The project operates an open
...
Whether a pull request is merged into WhaleCoin Core rests with the project merge
...
Patches that change WhaleCoin consensus rules are considerably more involved than
...
Where a patch set proposes to change the WhaleCoin consensus, it must have been
...
The project leader is the release manager for each WhaleCoin Core release.
