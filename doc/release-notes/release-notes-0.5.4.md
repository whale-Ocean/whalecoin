...
Fix Whalecoin-Qt notifications under Growl 1.3.
Increase required age of Whalecoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBitcoin properly when installing Whalecoin-Qt over it. (Windows)
