...
installer (on Windows) or just copy over /Applications/Whalecoin-Qt (on Mac) or
...
defaults to 0.00001. This will cause transactions with fewer WhaleCoin/kB fee to be
...
- #6116 `30dc3c1` [OSX] rename Whalecoin-Qt.app to Bitcoin-Core.app
