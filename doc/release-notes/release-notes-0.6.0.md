...
Whalecoin-Qt can display and save QR codes for sending
...
versions of Whalecoin-Qt/bitcoind.
...
Whalecoin-Qt's initial splash screen
...
opening/launching Whalecoin-Qt is available only on Linux,
and only if you configure your desktop to launch
Whalecoin-Qt. All platforms support dragging and dropping
bitcoin: URIs onto the Whalecoin-Qt window to start
payment.
...
It is expected that future releases of Whalecoin-Qt
