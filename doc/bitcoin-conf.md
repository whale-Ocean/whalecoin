...
The configuration file is used by `whalecoind`, `bitcoin-qt` and `bitcoin-cli`.
...
-- | -- | --
Windows | `%APPDATA%\WhaleCoin\` | `C:\Users\username\AppData\Roaming\WhaleCoin\bitcoin.conf`
Linux | `$HOME/.WhaleCoin/` | `/home/username/.WhaleCoin/bitcoin.conf`
macOS | `$HOME/Library/Application Support/WhaleCoin/` | `/Users/username/Library/Application Support/WhaleCoin/bitcoin.conf`
